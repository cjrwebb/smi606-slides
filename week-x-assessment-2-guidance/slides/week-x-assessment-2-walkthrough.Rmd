...
# .tuos_purple[SMI606: Assessment 2<br>Guidance & Walkthrough]
...
[Link to the assessment guidance](https://vle.shef.ac.uk/bbcswebdav/xid-43959194_1).
...
* **Spatial Analysis** [(Week 11)](https://calumwebb.co.uk/teaching/SMI606-content/week-11/slides/#1)
  * Variables linked to spatial data; no independent or dependent variables but it will be common to compare more than one variable over space ('space' can be thought of as the independent variable), or the same variable in two different areas (cities, regions).
      ...
      * If challenging yourself with a [spatial lag model](https://kimura.univ-montp2.fr/~rousset/spaMM/spaMMintro.pdf) distance based matrices follow a Matérn function, neighbour matrices follow an adjacency function.
...
`r icons::feather_icons("circle")` Did you transform/recode your variables in any way? (Recoding: [Week 8 Slides 36-47](https://calumwebb.co.uk/teaching/SMI606-content/week-8/slides/?panelset1=what-will-i-learn%253F2#36), Transforming: [Week 8 Slides 48-56](https://calumwebb.co.uk/teaching/SMI606-content/week-8/slides/?panelset1=what-will-i-learn%253F2#48))

`r icons::feather_icons("circle")` How did you assess model fit ([R-square](https://calumwebb.co.uk/teaching/SMI606-content/week-7/slides/?panelset1=what-will-i-learn%253F2#48)/[Accuracy](https://calumwebb.co.uk/teaching/SMI606-content/week-9/slides/?panelset1=what-will-i-learn%253F2#60)/[k-fold validation](https://calumwebb.co.uk/teaching/SMI606-content/week-9/slides/?panelset1=what-will-i-learn%253F2#73))?

`r icons::feather_icons("circle")` How did you check for any violations of assumptions ([linearity, homoscedasticity, outliers/leverage points, normality of residuals](https://calumwebb.co.uk/teaching/SMI606-content/week-8/slides/?panelset1=what-will-i-learn%253F2#57), [multicollinearity](https://calumwebb.co.uk/teaching/SMI606-content/week-8/slides/?panelset1=what-will-i-learn%253F2#69), [autocorrelation](https://calumwebb.co.uk/teaching/SMI606-content/week-9/slides/?panelset1=what-will-i-learn%253F2#93))?
...
`r icons::feather_icons("circle")` Which variables (features) did you include? ([Week 10: Slides 23-24](https://calumwebb.co.uk/teaching/SMI606-content/week-10/slides/?panelset1=what-will-i-learn%253F2#23))
...
`r icons::feather_icons("circle")` Regression coefficients and interpretation ([Week 7: Slides 47-58](https://calumwebb.co.uk/teaching/SMI606-content/week-7/slides/?panelset1=what-will-i-learn%253F2#47))
  * Remember to use the correct scale units when interpreting coefficients! 

`r icons::feather_icons("circle")` Model fit ([Week 7: Slides 47-58](https://calumwebb.co.uk/teaching/SMI606-content/week-7/slides/?panelset1=what-will-i-learn%253F2#47))

`r icons::feather_icons("circle")` Null hypothesis significance tests and interpretation, if appropriate (p-values) ([Week 7: Slides 47-58](https://calumwebb.co.uk/teaching/SMI606-content/week-7/slides/?panelset1=what-will-i-learn%253F2#47))

`r icons::feather_icons("circle")` (Optional but can be helpful) Marginal effects/predicted values plot ([Week 8: Slides 17-19](https://calumwebb.co.uk/teaching/SMI606-content/week-8/slides/?panelset1=what-will-i-learn%253F2#17))
...
`r icons::feather_icons("circle")` Assumptions (some people like to put these in the discussion section, or in a 'limitations and model checking' section after their discussion but before their conclusions. Either way is fine with me!)
  * Linearity ([Week 8: Slides 58-59](https://calumwebb.co.uk/teaching/SMI606-content/week-8/slides/?panelset1=what-will-i-learn%253F2#58))
  * Homoscedasticity ([Week 8: Slides 60-61](https://calumwebb.co.uk/teaching/SMI606-content/week-8/slides/?panelset1=what-will-i-learn%253F2#60))
  * No outliers or leverage points ([Week 8: Slides 62-65](https://calumwebb.co.uk/teaching/SMI606-content/week-8/slides/?panelset1=what-will-i-learn%253F2#62))
  * Normality of residuals ([Week 8: Slides 66-67](https://calumwebb.co.uk/teaching/SMI606-content/week-8/slides/?panelset1=what-will-i-learn%253F2#66))
  ...
  * No autocorrelation ([Week 9: Slides 89-95](https://calumwebb.co.uk/teaching/SMI606-content/week-9/slides/?panelset1=what-will-i-learn%253F2#89))
  * What could you do if assumptions are violated? 
    * Linearity, homoscedasticity, outliers, normality: [Week 8 Slide 68](https://calumwebb.co.uk/teaching/SMI606-content/week-8/slides/?panelset1=what-will-i-learn%253F2#68)
